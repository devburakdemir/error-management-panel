...
<html>
<head>
    <title>Simax Errors Yönetimi</title>
    <style>
...
<div class="container">
    <a href="${pageContext.request.contextPath}/admin/errors/create" class="btn">Yeni Hata Ekle</a>
        ...
        <table id="errorTable">
            ...
            <c:forEach var="error" items="${errors}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/errors/edit/${error.errorCode}" class="btn">Düzenle</a>
                        <a href="${pageContext.request.contextPath}/admin/errors/delete/${error.errorCode}"
